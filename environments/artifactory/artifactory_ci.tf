...
resource "artifactory_permission_target" "ci-permission" {
  ...
  repo {
    repositories = [
      artifactory_remote_repository.docker-remote.key,
      artifactory_remote_repository.gradle-remote.key,
      artifactory_remote_repository.gradle-plugins-remote.key,
      artifactory_remote_repository.pypi-remote.key
    ]
